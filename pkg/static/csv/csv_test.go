...
func TestCSVProcessor_GetDocuments_EmptyDirectory(t *testing.T) {
	...
	// Should handle empty directory gracefully - no CSV files
	expectedFiles := 0
...
func TestCSVProcessor_ListFiles_EmptyDirectory(t *testing.T) {
	processor := NewProcessor()
	ctx := context.Background()
