...
func TestPDFProcessor_GetDocuments_EmptyDirectory(t *testing.T) {
	...
	// Should handle empty directory gracefully - no PDF files
	expectedFiles := 0
...
func TestPDFProcessor_ListFiles_EmptyDirectory(t *testing.T) {
	processor := NewProcessor()
	ctx := context.Background()
